...
const InvesstingCom = ({title, pubDate, link,name, categories }) => {
   const formatted = {
    day: 'numeric',
    month: 'long',
    year: 'numeric',
    ...
    <>
     <a href={link} className='mb-9 text-sm hover:text-blue-600 text-gray-500'>
      ...
      <h1 className='mb-6 text-xl text-white italic text-center'>
        <TypeAnimation speed={2}  cursor={false} sequence={[title, 1000]} wrapper='h1' repeat={Infinity} className='text-yellow-300 italic ' />
        </h1>
